...
class GliaStream(ZmqStream):
    def __init__(self,
                ...
                **kw):
        super(GliaStream,self).__init__(
                        [frame1_dtypes, frame2_dtypes], 
                        data, 
                        si_conversion, 
                        clockreferenceid,
                    **kw)
    ...
    def load(self):
        self.data = load_zeromq([self.device + '_Frame1.bin', self.device + '_Frame2.bin'], 
